    ...
    <Slider {...settings}>
          ...
          {data?.data?.data.map((cat) => <div key={cat._id} className='text-center my-3' >
            <div className='w-[90px] h-[90px] rounded-full mx-auto'>
             ...
             <img loading="eager" fetchpriority="high" src={cat.image} className='w-full h-full rounded-full hover:shadow-xl transition duration-500 dark:hover:shadow-xl dark:hover:shadow-gray-700' alt="" /> :
