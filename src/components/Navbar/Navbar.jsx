...
<nav className="bg-white border-gray-200 dark:bg-gray-900 sticky top-0 left-0 right-0 h-[80px] max-h-[300px] md:h-[100px] z-[99]">
  ...
  <div className="flex items-center bg-transparent flex-row px-0 md:p-4 p-0  font-medium border border-gray-100 rounded-lg bg-gray-50 space-x-5 md:space-x-5 lg:space-x-8 rtl:space-x-reverse flex-row md:mt-0 border-0 ">
      ...
      <button data-collapse-toggle="navbar-cta" type="button" className="inline-flex items-center mt-1 p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden dark:text-gray-400 " aria-controls="navbar-cta" aria-expanded="false">
